...
export function Sidebar({ isOpen, isMobile, currentPage, onPageChange, onToggle, userRol, className }) {
  ...
  const menuItems = useMemo(() => {
    ...
    const items = [
      ...
      { label: 'Inscripciones',  icon: UserPlus,      page: 'gestion-inscripciones', module: 'inscripciones' },
      ...
      { label: 'Posiciones',     icon: Medal,         page: 'tabla-posiciones',     module: 'estadisticas' },
