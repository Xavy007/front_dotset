...
export default function ResetearPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch(`${API_BASE}/usuario/reset/${token}`, {
        method: 'POST',
        ...
        <div className="glass neon-border w-full max-w-md rounded-2xl p-8">
          ...
          {exito ? (
            <div className="text-center py-8">
              ...
              <h2 className="text-2xl font-semibold text-green-400 mb-2">¡Contraseña restablecida!</h2>
              <p className="text-white/70 text-sm">Tu contraseña fue actualizada correctamente.<br />Serás redirigido al login en unos segundos.</p>
            </div>
          ) : (
            <>
              <header className="mb-8 text-center">
                ...
                <h1 className="text-2xl font-semibold tracking-wide">
                  Nueva <span className="text-[--color-neon]">contraseña</span>
                </h1>
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <label className="block text-sm">
                  <span className="mb-2 inline-block text-white/80">Nueva contraseña</span>
                  <div className="relative">
                    ...
                    <button type="button" onClick={() => setShowPass(s => !s)}
                      ...
                      {showPass
                        ? <svg width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M2.39 1.73L1.11 3l4.05 4.05C3.2 8.42 1.73 10.08 1 12c1.73 4.39 6 7.5 11 7.5c2 0 3.87-.5 5.5-1.36l3.39 3.39l1.27-1.27L2.39 1.73M12 6.5c3 0 5.8 1.64 7.34 4.13c-.51 1-1.26 1.87-2.16 2.57l-1.46-1.46A3.95 3.95 0 0 0 12 8.5c-.37 0-.73.05-1.07.14L9.3 7.01c.84-.33 1.77-.51 2.7-.51M7.58 9.08l1.57 1.57c-.1.26-.15.55-.15.85a2.99 2.99 0 0 0 3 3c.3 0 .59-.05.85-.15l1.57 1.57c-.7.9-1.58 1.65-2.58 2.16A8.5 8.5 0 0 1 3.66 12c.51-1.01 1.26-1.88 2.16-2.92l1.76 0z"/></svg>
                        : <svg width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M12 5c-5 0-9.27 3.11-11 7.5C2.73 16.89 7 20 12 20s9.27-3.11 11-7.5C21.27 8.11 17 5 12 5m0 12.5A5 5 0 1 1 12 7a5 5 0 0 1 0 10.5m0-2.5a3 3 0 1 0 0-6a3 3 0 0 0 0 6"/></svg>
                      }
                    </button>
                  </div>
                </label>
